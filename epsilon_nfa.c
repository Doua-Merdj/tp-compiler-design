...
// new transitions without epsilon
 int new_transitions[MAX_STATES][MAX_SYMBOLS][MAX_STATES]; int new_final[MAX_STATES];
...
/* ====================================== Task 2: Compute epsilon-closure ====================================== */ void computeEclosure() { int i, j, k;
...
/* ================================================== Task 3: Compute new transitions without epsilon ================================================== */ void computeNewTransitions() { int i, j, k, p, q; memset(new_transitions, 0, sizeof(new_transitions));
...
/* ====================================== Task 4: Determine new final states ====================================== */ void computeNewFinalStates() { int i, j; memset(new_final, 0, sizeof(new_final));
...
/* ====================================== Task 5: Display the new automaton ====================================== */ void displayNFA() { int i, j, k; printf("\nNFA without epsilon transitions:\n"); printf("States: %d\n", n_states); printf("Start state: %d\n", start_state);
